    ...
    <div className="bg-[#FFB653] pt-5 pb-10 px-8 relative ">
      ...
      <section className="w-10/12 mx-auto flex justify-between gap-5 mt-10">
        ...
        <div className="w-[35%]">
          ...
          <p className="text-right text-xs font-normal text-black text-opacity-[57%]">
            *3.5% commision on battle amount
          </p>
        </div>
        <div className="w-[35%]">
          <div className="bg-white px-5 py-3 flex justify-between gap-8 items-center rounded-xl ">
            <svg
